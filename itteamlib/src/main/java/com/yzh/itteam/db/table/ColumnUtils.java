...
import com.yzh.itteam.db.converter.ColumnConverter;
import com.yzh.itteam.db.converter.ColumnConverterFactory;
import com.yzh.itteam.db.sqlite.FinderLazyLoader;
import com.yzh.itteam.db.sqlite.ForeignLazyLoader;
...
public class ColumnUtils {
    ...
    public static Class<?> getForeignEntityType(com.yzh.itteam.db.table.Foreign foreignColumn) {
    ...
    @SuppressWarnings("unchecked")
    public static Class<?> getFinderTargetEntityType(com.yzh.itteam.db.table.Finder finderColumn) {
