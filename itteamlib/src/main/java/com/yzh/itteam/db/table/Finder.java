...
import com.yzh.itteam.db.sqlite.ColumnDbType;
...
public class Finder extends Column {
	...
	/* package */Finder(Class<?> entityType, Field field) {
		...
		com.lidroid.xutils.db.annotation.Finder finder = field
				.getAnnotation(com.lidroid.xutils.db.annotation.Finder.class);
