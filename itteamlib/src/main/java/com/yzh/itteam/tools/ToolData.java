...
import com.yzh.itteam.data.DTO;
import com.yzh.itteam.view.CheckBox;
import com.yzh.itteam.view.RadioButton;
import com.yzh.itteam.view.RadioGroup;
import com.yzh.itteam.view.SingleSpinner;
	...
	public static DTO<String,Object> gainForm(ViewGroup root,DTO<String,Object> data) {
		if (root.getChildCount() > 0) {
			for (int i = 0; i < root.getChildCount(); i++) {
				...
				}else if (view.getClass().getName().equals(CheckBox.class.getName())) {
					
					CheckBox mView = (CheckBox)view;
					if (mView.isChecked()) {
				...
				}else if (view.getClass().getName().equals(SingleSpinner.class.getName())) {
